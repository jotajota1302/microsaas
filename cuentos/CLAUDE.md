...
**Lo que sí está hecho y desplegado**: `/imprimir/` y `/en/print/` («cómo tenerlo en papel»), con los tres caminos reales — casa, copistería, e imprenta que acepta PDF (**Blurb** y **Lulu**, verificados el 22-08; los álbumes tipo **Hofmann** solo funcionan con su editor, no admiten un PDF hecho). Recogen correo para la futura edición impresa (`waitlist`, `reason: "print"`) y el botón «Quiero el libro impreso» ya promete un aviso por email, no un «si hay suficientes familias».
